  ...
  <div class="topics-page">
    <div class="container">
      <div class="page-header">
        <h1 class="page-title animate-slide-up">🎯 Choose Your Topic</h1>
        <p class="page-subtitle animate-slide-up">Pick a subject and start your STEM adventure!</p>
      </div>
        ...
        >
          ...
          <div class="subtopics">
            ...
            <div class="subtopic-tags">
              <span v-for="sub in topic.subtopics" :key="sub" class="subtopic-tag">
                {{ sub }}
              </span>
            </div>
          </div>
